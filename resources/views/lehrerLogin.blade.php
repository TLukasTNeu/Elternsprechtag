                                        ...
                                        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                                         ...
                                         <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                             <ul class="navbar-nav ms-auto">
                                                ...
                                                <li class="nav-item">
                                                        <a class="nav-link active" aria-current="page" href="/adminShowLoginView"> ADMIN </a>      
                                                    </li>
                 ...
                 <div class="col-lg-4">
                    ...
                    <div class="card border-0"> 
                        <div class="card-title"> 
                            <div class="pt-3 text-center " style="font-size: 20px;">  ELTERNSPRECHTAG | LEHRERLOGIN </div> 
                        </div> 
                        ...
                        <div class="card-body p-5"> 
                                ...
                                @endif
                                  ...
                                  <div class="form-group">
                                     ...
                                     <label for="schluessel"> Lehrer-ID </label>
                                    <input type="username" name="lehrerID" class="form-control mt-1" id="x" placeholder="">
                                  ...
                                  <button type="submit" class="btn btn-dark mt-3 rounded-2 "> Anmelden </button> 
                                  </form>
