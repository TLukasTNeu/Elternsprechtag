        ...
        <div class="container mt-5"> 
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center"> 
                    ...
                    <div class="card p-2 bg-dark text-light"> <strong>  Prof. {{$data->lehrerVN}} {{$data->lehrerNN}}</strong> Meine Termine
                ...
                <div class="col-md-4 text-center mt-3">
                    <div class="btn btn-success" href="javascript:void(0);"onclick="printPageArea('printableArea')"> Liste drucken </div> 
                </div>
                    ...
                    <div class="card bg-dark text-light table-responsive text-nowrap" id="printableArea"> 
                        ...
                        <table name="zeitt"class="table text-light "> 
                            ...
                            @foreach($display as $u)
                               ...
                               @php
                               for($i = 0; $i<=count($schueler)-1;$i++)
                                  {
                                    if($u->schuelerID == $schueler[$i]->schuelerID)
                                    {
                                      $nameVN = $schueler[$i]->schuelerVN;
                                      $nameNN = $schueler[$i]->schuelerNN;
                                    }
                               ...
                               @endphp
                                  ...
                                  @php
                                    ...
                                    $timeS = $data->dauerProSprechstunde;
